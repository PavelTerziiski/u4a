      ...
      <div className="u4a-dash">
        ...
        <div className="dash-content">
          <div className="greeting-card fade-up" style={{display:"flex",alignItems:"center",gap:14}}>
            <div style={{width:90,height:90,borderRadius:'50%',border:'4px solid #FED7AA',flexShrink:0,overflow:'hidden',background:'#FFF7ED'}}><img src={`/avatars/${['fox','bear','owl','squirrel','deer','rabbit','hedgehog','wolf'][(profile?.avatar_id || 1) - 1]}.png`} style={{width:'100%',height:'100%',objectFit:'cover',objectPosition:'center 15%',transform:'scale(1.4)',transformOrigin:'center 15%'}} />
            <div style={{flex:1}}>
        ...
        <div className="bottom-nav">
          <div className="nav-item active">
            <span style={{background:"white",borderRadius:"50%",width:72,height:72,display:"flex",alignItems:"center",justifyContent:"center",marginBottom:2,boxShadow:"0 2px 8px rgba(0,0,0,0.15)"}}><img src="/icons/home.png" style={{width:44,height:44,objectFit:"contain"}} /></span>
            Начало
          </div>
          <div className="nav-item" onClick={() => router.push('/dictation')}>
            <span style={{background:"white",borderRadius:"50%",width:72,height:72,display:"flex",alignItems:"center",justifyContent:"center",marginBottom:2,boxShadow:"0 2px 8px rgba(0,0,0,0.15)"}}><img src="/icons/dictations.png" style={{width:44,height:44,objectFit:"contain"}} /></span>
            Диктовки
          </div>
          <div className="nav-item">
            <span style={{background:"white",borderRadius:"50%",width:72,height:72,display:"flex",alignItems:"center",justifyContent:"center",marginBottom:2,boxShadow:"0 2px 8px rgba(0,0,0,0.15)"}}><img src="/icons/friends.png" style={{width:44,height:44,objectFit:"contain"}} /></span>
            Приятели
          </div>
          <div className="nav-item" onClick={() => router.push('/settings')}>
            <span style={{background:"white",borderRadius:"50%",width:72,height:72,display:"flex",alignItems:"center",justifyContent:"center",marginBottom:2,boxShadow:"0 2px 8px rgba(0,0,0,0.15)"}}><img src="/icons/settings.png" style={{width:44,height:44,objectFit:"contain"}} /></span>
            Настройки
          </div>
        </div>
      </div>
