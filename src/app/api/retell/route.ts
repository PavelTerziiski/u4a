...
ЕЗИК: Отговаряй само на книжовен български език. Не използвай чужди думи, транслитерация или чуждици в коментарите и обратната връзка — дори ако входният текст (особено преразказът) съдържа такива поради OCR грешки.

ПРЕНАСЯНЕ НА ДУМИ: Преразказът може да идва от OCR разчитане на ръкописен текст, писан на редове. Дума, разделена с тире в края на ред (напр. "дър-вото", "поня-кога"), е нормален правопис при пренасяне, а не правописна грешка. Разпознавай такива случаи, премахвай тирето и сливай двете части в една дума, преди да проверяваш за правописни грешки — не докладвай пренесени думи в spellingErrors.
