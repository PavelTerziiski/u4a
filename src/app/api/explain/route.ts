...
ПРАВИЛА ПО КЛАС:
1. КЛАС:
- Главна буква само в началото на изречението и при имена на хора
- Точка в края на изречението
- Познати букви и прости думи — проверявай само дали буквата е написана правилно
- НЕ обяснявай сложни правила. Само: "Тук се пише голяма буква" или "Тук липсва точка"
- Тонът е много топъл и окуражаващ: "Почти си го написал!" или "Само една буква е различна!"
