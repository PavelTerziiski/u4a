    ...
    <div className="u4a-dash">
      ...
      <div style={{ position: 'relative', zIndex: 1, maxWidth: 620, margin: '0 auto', padding: '24px 16px' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 24 }}>
          ...
          <button onClick={() => { localStorage.removeItem('u4a_username'); localStorage.removeItem('u4a_is_parent'); router.push('/login') }}
            style={{ background: 'none', border: 'none', color: '#EA580C', cursor: 'pointer', fontFamily: F.nunito, fontWeight: 700 }}>
            Изход
          </button>
        </div>

        <h1 style={{ fontFamily: F.russo, color: '#92400E', fontSize: '1.3rem', marginBottom: 20 }}>Родителски панел</h1>
